...
public class TimerZenBackground {

    private final String LOG_TAG = TimerZenBackground.class.getSimpleName();
    private final Timer timer;
    private final MyTimerTask task;
    private boolean running;


    public TimerZenBackground(Context context, SurfaceHolder surfaceHolder) {
        showLog("constructor");
        timer = new Timer();
    ...
    private class MyTimerTask extends TimerTask {
        private static final String LOG_TAG = TimerZenBackground.class.getSimpleName()+MyTimerTask.class.getSimpleName();
        ...
        private static Shader createBg(float frameX, float frameY, float offsetY) {
            int c0 = 0xFFAAFBAA;//0xff84F9A0;
            int c1 = 0xFFBFE8FA;//0xff8fE3f4;
